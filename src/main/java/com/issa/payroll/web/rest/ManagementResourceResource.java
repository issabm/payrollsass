...
public class ManagementResourceResource {
    ...
    public ResponseEntity<ManagementResource> updateManagementResource(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, managementResource.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ManagementResource> partialUpdateManagementResource(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, managementResource.getId().toString())
        );
    }
