...
/**
 * REST controller for managing {@link com.issa.payroll.domain.NiveauEtude}.
 */
@RestController
@RequestMapping("/api")
public class NiveauEtudeResource {
    ...
    public ResponseEntity<NiveauEtude> createNiveauEtude(@RequestBody NiveauEtude niveauEtude) throws URISyntaxException {
    ...
    public ResponseEntity<NiveauEtude> updateNiveauEtude(
        ...
        @RequestBody NiveauEtude niveauEtude
    ...
    public ResponseEntity<List<NiveauEtude>> getAllNiveauEtudes(Pageable pageable) {
