...
public class Devise implements Serializable {
    ...
    public Devise libAr(String libAr) {
        this.setLibAr(libAr);
        return this;
    }
    ...
    public Devise libEn(String libEn) {
        this.setLibEn(libEn);
        return this;
    }
    ...
    public Devise dateop(ZonedDateTime dateop) {
    ...
    public Devise util(String util) {
        this.setUtil(util);
        return this;
    }
    ...
    public Devise modifiedBy(String modifiedBy) {
    ...
    public Devise isDeleted(Boolean isDeleted) {
    ...
    public Devise createdDate(ZonedDateTime createdDate) {
    ...
    public Devise modifiedDate(ZonedDateTime modifiedDate) {
