...
public class Category implements Serializable {
    ...
    public Category libAr(String libAr) {
        this.setLibAr(libAr);
        return this;
    }
    ...
    public Category libEn(String libEn) {
        this.setLibEn(libEn);
        return this;
    }
    ...
    public Category util(String util) {
        this.setUtil(util);
        return this;
    }
    ...
    public Category dateop(ZonedDateTime dateop) {
    ...
    public Category modifiedDate(ZonedDateTime modifiedDate) {
    ...
    public Category pays(Pays pays) {
        this.setPays(pays);
        return this;
    }
    ...
    public Category natureConfig(NatureConfig natureConfig) {
    ...
    public Category affilication(Affiliation affiliation) {
    ...
    public Category entreprise(Entreprise entreprise) {
