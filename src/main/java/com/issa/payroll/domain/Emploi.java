...
public class Emploi implements Serializable {
    ...
    public Emploi code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public Emploi libAr(String libAr) {
        this.setLibAr(libAr);
        return this;
    }
    ...
    public Emploi libEn(String libEn) {
        this.setLibEn(libEn);
        return this;
    }
    ...
    public Emploi util(String util) {
        this.setUtil(util);
        return this;
    }
    ...
    public Emploi dateop(ZonedDateTime dateop) {
    ...
    public Emploi modifiedBy(String modifiedBy) {
    ...
    public Emploi isDeleted(Boolean isDeleted) {
    ...
    public Emploi createdDate(ZonedDateTime createdDate) {
    ...
    public Emploi modifiedDate(ZonedDateTime modifiedDate) {
    ...
    public Emploi natureConfig(NatureConfig natureConfig) {
    ...
    public Emploi affilication(Affiliation affiliation) {
    ...
    public Emploi entreprise(Entreprise entreprise) {
    ...
    public Emploi groupe(Groupe groupe) {
