...
public class TypeContrat implements Serializable {
    ...
    public TypeContrat libAr(String libAr) {
        this.setLibAr(libAr);
        return this;
    }
    ...
    public TypeContrat libEn(String libEn) {
        this.setLibEn(libEn);
        return this;
    }
    ...
    public TypeContrat util(String util) {
        this.setUtil(util);
        return this;
    }
    ...
    public TypeContrat dateop(ZonedDateTime dateop) {
    ...
    public TypeContrat modifiedBy(String modifiedBy) {
    ...
    public TypeContrat op(String op) {
        this.setOp(op);
        return this;
    }
    ...
    public TypeContrat isDeleted(Boolean isDeleted) {
    ...
    public TypeContrat createdDate(ZonedDateTime createdDate) {
    ...
    public TypeContrat modifiedDate(ZonedDateTime modifiedDate) {
    ...
    public TypeContrat pays(Pays pays) {
        this.setPays(pays);
        return this;
    }
