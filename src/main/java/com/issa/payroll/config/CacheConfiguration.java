...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.issa.payroll.domain.PalierPlate.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.PalierCondition.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, com.issa.payroll.domain.ModeInput.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, com.issa.payroll.domain.NiveauEtude.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, com.issa.payroll.domain.Plate.class.getName(), jcacheConfiguration);
            ...
            createCache(cm, com.issa.payroll.domain.NatureConfig.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.ManagementResourceFun.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.Payroll.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.NatureMvtPaie.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.NatureEligibilite.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.TargetEligible.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.Eligibilite.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.EligibiliteExclude.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.MouvementPaie.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.DemandeCalculPaie.class.getName(), jcacheConfiguration);
            createCache(cm, com.issa.payroll.domain.PlateInfo.class.getName(), jcacheConfiguration);
