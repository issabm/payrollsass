...
describe('NiveauEtude Management Component', () => {
  let comp: NiveauEtudeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [NiveauEtudeComponent],
      providers: [
        Router,
        {
      ...
      .overrideTemplate(NiveauEtudeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.niveauEtudes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
