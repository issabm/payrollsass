...
export class NiveauEtudeComponent implements OnInit {
  ...
  protected onSuccess(data: INiveauEtude[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/niveau-etude'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
