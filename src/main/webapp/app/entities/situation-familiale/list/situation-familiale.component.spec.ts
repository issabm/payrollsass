...
describe('SituationFamiliale Management Component', () => {
  let comp: SituationFamilialeComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(SituationFamilialeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.situationFamiliales?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
