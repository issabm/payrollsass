...
describe('Frequence Management Component', () => {
  let comp: FrequenceComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(FrequenceComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.frequences?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
