...
describe('Identite Management Component', () => {
  let comp: IdentiteComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(IdentiteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.identites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
