...
describe('Affectation routing resolve service', () => {
  ...
  let resultAffectation: IAffectation | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IAffectation if id is not provided', () => {
      // GIVEN
      ...
      expect(resultAffectation).toEqual(new Affectation());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Affectation })));
      mockActivatedRouteSnapshot.params = { id: 123 };
