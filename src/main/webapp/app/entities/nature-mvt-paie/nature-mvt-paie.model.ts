...
export interface INatureMvtPaie {
  id?: number;
  code?: string | null;
  libEn?: string | null;
  libAr?: string | null;
...
export class NatureMvtPaie implements INatureMvtPaie {
  constructor(
    public id?: number,
...
export function getNatureMvtPaieIdentifier(natureMvtPaie: INatureMvtPaie): number | undefined {
  return natureMvtPaie.id;
}
