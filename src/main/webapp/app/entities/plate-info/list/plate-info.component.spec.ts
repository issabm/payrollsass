...
describe('PlateInfo Management Component', () => {
  let comp: PlateInfoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PlateInfoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.plateInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
