...
describe('NiveauScolaire Management Component', () => {
  let comp: NiveauScolaireComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [NiveauScolaireComponent],
      providers: [
        Router,
        {
      ...
      .overrideTemplate(NiveauScolaireComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.niveauScolaires?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
