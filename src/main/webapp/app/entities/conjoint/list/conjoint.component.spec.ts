...
describe('Conjoint Management Component', () => {
  let comp: ConjointComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ConjointComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.conjoints?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
