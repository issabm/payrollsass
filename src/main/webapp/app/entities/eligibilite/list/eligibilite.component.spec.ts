...
describe('Eligibilite Management Component', () => {
  let comp: EligibiliteComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(EligibiliteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.eligibilites?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
