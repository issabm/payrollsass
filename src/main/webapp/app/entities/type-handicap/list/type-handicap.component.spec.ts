...
describe('TypeHandicap Management Component', () => {
  let comp: TypeHandicapComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(TypeHandicapComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.typeHandicaps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
