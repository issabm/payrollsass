...
import { PayrollInfoComponent } from './payroll-info.component';

describe('PayrollInfo Management Component', () => {
  let comp: PayrollInfoComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PayrollInfoComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.payrollInfos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
