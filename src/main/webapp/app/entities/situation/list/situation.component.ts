...
export class SituationComponent implements OnInit {
  ...
  trackId(index: number, item: ISituation): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: ISituation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
