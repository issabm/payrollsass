...
describe('Rebrique Management Component', () => {
  let comp: RebriqueComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RebriqueComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rebriques?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
